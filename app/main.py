...
def _load_prompt(filename: str) -> str:
    """Read a prompt from app/prompts/ — kept out of the source so long,
    prose-heavy instructions can be edited/reviewed as text, not Python string
    literals."""
...
AUDIO_MODE_ADDENDUM = _load_prompt("audio_mode_addendum.md")
